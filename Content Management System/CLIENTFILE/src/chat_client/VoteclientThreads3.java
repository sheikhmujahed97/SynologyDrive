...
public class VoteclientThreads3 extends Thread {
    static int c=0;
    JTextArea status;
   String[] votes = {"Yes", "No", "Yes", "No"};
    public VoteclientThreads3(JTextArea status){
       this.status=status;
    }
    ...
    public void run(){
                 if   (c==0)
                 {
                     ...
                     //Here it appends the message of the client 1 and client 2
...
//https://www.youtube.com/watch?v=DvE_Jw8Upn0
        ...
        // https://www.javatpoint.com/java-joptionpane
                    JOptionPane.showMessageDialog(null,"VOTE YES FROM CLIENT1");
                         JOptionPane.showMessageDialog(null,"VOTE YES AT CLIENT2");
                         //Here it appends the message of the client 1 and client 2
                         //code of taking status in the thread and updating the UI is taken from the below video
//https://www.youtube.com/watch?v=DvE_Jw8Upn0
...
//https://www.youtube.com/watch?v=DvE_Jw8Upn0
        ...
        // https://www.javatpoint.com/java-joptionpane
                         JOptionPane.showMessageDialog(null,"VOTE YES FROM CLIENT1");
                         JOptionPane.showMessageDialog(null,"TIME OUT AT CLIENT2");
                         //Here it appends the message of the client 1 and client 2
                         //code of taking status in the thread and updating the UI is taken from the below video
// https://www.youtube.com/watch?v=DvE_Jw8Upn0
            status.append("YES FROM CLIENT1\n TIME OUT AT CLIENT2 ");
