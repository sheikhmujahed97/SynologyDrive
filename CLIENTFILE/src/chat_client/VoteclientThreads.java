...
public class VoteclientThreads extends Thread {
    static int c=0;
    JTextArea status;
   String[] votes = {"Yes", "No", "Yes", "No"};
   public VoteclientThreads(JTextArea status){
       this.status=status;
   }
    ...
    public void run(){
        ...
        // https://www.javatpoint.com/java-joptionpane
                     ...
                     if(votes[0]!=votes[1]){
                     JOptionPane.showMessageDialog(null,"VOTE YES FROM CLIENT2");
                     JOptionPane.showMessageDialog(null,"VOTE NO FROM CLIENT3");
                     //Here it appends the message of the client 2 and client 3
...
//https://www.youtube.com/watch?v=DvE_Jw8Upn0
                     status.append("YES FROM CLIENT2\n NO FROM CLIENT3 ");
...
//https://www.youtube.com/watch?v=DvE_Jw8Upn0
        ...
        // https://www.javatpoint.com/java-joptionpane
                    JOptionPane.showMessageDialog(null,"VOTE YES FROM CLIENT2");
                         JOptionPane.showMessageDialog(null,"VOTE YES AT CLIENT3");
                         //Here it appends the message of the client 2 and client 3
                         //code of taking status in the thread and updating the UI is taken from the below video
//https://www.youtube.com/watch?v=DvE_Jw8Upn0
           status.append("YES FROM CLIENT2\n YES FROM CLIENT3 ");
                 ...
                 if(c==3){
                      if(votes[0]!=votes[1]){
                     JOptionPane.showMessageDialog(null,"VOTE NO FROM CLIENT2");
                     JOptionPane.showMessageDialog(null,"VOTE NO FROM CLIENT3");
                     //Here it appends the message of the client 2 and client 3
                     //code of taking status in the thread and updating the UI is taken from the below video
//https://www.youtube.com/watch?v=DvE_Jw8Upn0
                     status.append("NO FROM CLIENT2\n NO FROM CLIENT3 ");
                 }
                 }
