...
import static chat_client.ClientWatcherThread.flag;
...
public class Client2WatcherThread extends Thread {
    String servertrack;
    JTextArea status;
    static int flag=0;
...
private String destinationPathclient1 = "C:/Users/User/Desktop/client2/";
...
//Getting the text and outputstream from the client form
    public Client2WatcherThread(JTextArea status,ObjectOutputStream outputstream) {
        this.status=status;
...
//https://www.dev2qa.com/java-move-files-between-directories/   
                 try
		{
                    ...
                    String srcFilePath="C:/Users/User/Desktop/client2/"+fileName;
