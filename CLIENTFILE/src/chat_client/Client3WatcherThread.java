...
public class Client3WatcherThread extends Thread {
    String servertrack;
    JTextArea status;
    static int stop=0;
    static int flag=0;
...
private String destinationPathclient1 = "C:/Users/User/Desktop/client3/";
...
//Getting the text and outputstream from the client form
    public Client3WatcherThread(JTextArea status,ObjectOutputStream outputstream) {
        this.status=status;
...
// https://www.javatpoint.com/java-joptionpane
     ...
     // This variable is static as the variable is been running on he static function
       ...
       sourceFilePath="C:" + "/" + "Users" + "/"+"User"+"/"+"Desktop"+"/"+"client3"+"/"+fileName;
...
try {
 outputStream1.writeObject(fileEvent);
...
//https://www.dev2qa.com/java-move-files-between-directories/   
                 try
		{
                    ...
                    String srcFilePath="C:/Users/User/Desktop/client3/"+fileName;
                    
                    
                    
                    String destFilePath="C:/Users/User/Desktop/client1/"+fileName;
...
*/
                    File tempFile = new File("C:/Users/User/Desktop/client1/"+fileName);
boolean exists = tempFile.exists();


                    String destFilePath1="C:/Users/User/Desktop/client2/"+fileName;
...
*/
    //Here it checks for the file in the folder in order to avoid file copy exception
                   File tempFile1 = new File("C:/Users/User/Desktop/client2/"+fileName);
...
boolean exists2 = tempFile2.exists();
			...
			if(srcFilePath!=null && srcFilePath.trim().length()>0 && destFilePath!=null && destFilePath.trim().length()>0)
			{
				...
				Path targetPathObj = Files.copy(srcPathObj, destPathObj1);
                            ...
                            {
                                //if there is not redundancy in the destination folder then it transfers it
				Path targetPathObj = Files.copy(srcPathObj, destPathObj2);
